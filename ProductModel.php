...
$subcatid=$_REQUEST['subcatid'];
   ...
   $sql="select * from products where SubCategory_ID='$subcatid' ";
  ...
  <a href="ProductDetails.php?productid=<?php echo $i; ?>">

  <div class="col-sm-6 col-md-4" style="width:220px">
    <div class="thumbnail">
      <img src="/pro/admin/productUpload/<?php echo $arr['Image'] ?>" alt="hello">
      <div class="caption">
